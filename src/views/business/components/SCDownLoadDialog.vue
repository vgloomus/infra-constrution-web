 ...
 * @LastEditTime: 2024-10-31 19:33:55
...
<script>
import { mergeCompareDrawing } from '@/api/business'
import { mapState } from 'vuex'
export default {
  name: 'SCDownLoadDialog',
  props: {
    visible: {
      type: Boolean,
      default: false
  ...
  methods: {
    ...
    async pollDownloadShareDrawing() {
      try {
        const res = await mergeCompareDrawing(this.projectId, [this.taskId])
